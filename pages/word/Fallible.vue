	...
	<view class="Fallible">
		...
		<view class="fbl " style="padding: 300rpx 120rpx; ">
			...
			<view class="input flex_x_center" style="padding-top: 150rpx; ">
				<view class=" word-Border-radius" style="width: 60%;height: 100rpx; background: #506cff; padding-top:20rpx">
					<u--input
				    border="none"
					fontSize="40rpx"
					inputAlign="center"
			...
			<view class=" flex_x_center" style="padding-top: 80rpx  ;">
				...
				<view
				  class="word-text-border word-Border-radius but"
				  style="font-size: 30rpx; padding: 10rpx 40rpx"
				 @click="yes">
				  开始筛查
				</view>
			</view>
