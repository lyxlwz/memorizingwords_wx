<template>
  <view class="editor-container">
    ...
    <view
      v-if="isFixed"
      :class="{ 'fixed-top__place': isFixed }"
    ></view>
    ...
    >
      <view
        ...
        :style="{height: toolBarHeight + 'rpx'}"
      >
        <view
          class="toolbar-item-header"
          @touchend.stop="changeKeyBoard"
        ><i class="iconfont icon-keyboard"></i>
        </view>
        <!-- v-for="(icon, index) in ['icon-add', 'icon-textformat', 'icon-align-left']" -->
        <view
          v-for="(icon, index) in ['icon-textformat', 'icon-align-left']"
          :key="index"
          class="toolbar-item"
        ...
        >
          <i
            class="iconfont"
            :class="[icon, { active: toolBarContentShow && swiperCurrent == index }]"
          ></i>
        </view>

        <view
          class="toolbar-item"
          @touchend.stop="formatformat('check')"
        ><i class="iconfont icon-list-check"></i></view>
        <view
          class="toolbar-item"
          @touchend.stop="formatformat('undo')"
        ><i class="iconfont icon-undo"></i>
        </view>
        <view
          class="toolbar-item"
          @touchend.stop="formatformat('redo')"
        ><i class="iconfont icon-redo"></i>
        </view>
        <view
          class="toolbar-item-footer"
          @touchend.stop="hideToolbar"
            ...
            <view class="feature-items flex">
              ...
              >
                <view class="icon"><text
                    class="iconfont"
                    :class="'icon-' + pitem.icon"
                  ></text></view>
              </view>
            </view>
          </template> -->

          <template v-if="page.type === 'tool'">
            <view
              v-for="(pitem, pindex) in page.array"
              :key="pindex"
